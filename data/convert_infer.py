...
if __name__ == '__main__':
    ...
    arr = rnp.root2array(filenames=[froot], treename='events', branches=branches+met_branches+recoil_branches+jet1_branches+jet2_branches)
    ...
    recoil = recoil.astype(np.float16)
    jet1 = jet1.astype(np.float16)
    jet2 = jet2.astype(np.float16)

    np.savez(fnpy, x=arr, met=met, recoil=recoil, jet1=jet1, jet2=jet2)
